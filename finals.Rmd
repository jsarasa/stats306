...
3. Diagram 3: Shalini Asokkumar
  ...
  - **Interpretation of Diagram:** The least shocking of the results is shown in the high and upper middle income countries bracket, where the net births and deaths remained relatively stable except for a few shocks here and there. These can likely be associated with times of economic turmoil and income struggles. However, it is important to note, that recently these countries populations are predicted to be shrinking at an increasing rate. Many economists are calling this a cause for concern as it means there may be fewer people able to take on existing jobs. Across all 4 graphs, we see, that contrary to increasing life expectancy, people in all countries are, on average, expected to have fewer children. This is especially interesting to note in the Lower Middle Income Countries and the Low and Low Middle income countries, because their populations have been growing at an increasing rate for since before the 50s. Likely, this was due to cultural practices of having large families. So what can we attribute the decrease to? Recently, in higher income countries, as the costs of living increase, people have intentionally opted to have smaller families, and having no kids is also becoming a more popular idea. It could also be due to resource constraints. Parents want to give their kids the best lives possible, and may not want to have kids if they cannot ensure that possibility. The death rates in the lower income countries are likely increasing due to the growth in wealth disparities between higher and lower income nations, and a declining birth rate does not seem to be helping. 
...
est_and_med$region_subregion_country_area = factor(est_and_med$region_subregion_country_area, 
                                      levels = c("High-and-upper-middle-income countries",
