...
estimates |> 
  ...
  ggplot(aes(x = reorder(region_subregion_country_area, - sex_ratio_at_birth_males_per_100_female_births), y = sex_ratio_at_birth_males_per_100_female_births, fill = region_subregion_country_area)) + 
