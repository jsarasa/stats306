...
#linear model
lm_2100_pop <- lm(pop_2100 ~ total_pop_january_thousands + crude_birth_rate_per_1000_pop + crude_death_rate_deaths_per_1000_population + net_migration_rate_per_1000, data = training_data)
...
predict_data <- mutate(predict_data, predicted_2100_pop = predict(lm_2100_pop, newdata = predict_data))
```
