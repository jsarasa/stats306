...
```{r}
# 1 Sophia
# Question: How has the female life expectancy at age 15 evovled over the last 50 years in less developed regions compared to more developed regions? Is there a convergence in the female life expectancy rates?
...
estimates %>%
  ...
  scale_x_discrete(labels = c("High-and-Upper-Middle", "Low-and-Lower-Middle", "Lowerr-Middle", "Upper-Middle")) +
...
predict_2100_pop_values <- predict(lm_2100_pop, predict_data)

# Put values of linear model into predicted_2100_pop
predict_data <- mutate(predict_data, predicted_2100_pop = predict_2100_pop_values)
```
