...
estimates |> rbind(mediums) |> 
  filter (region_subregion_country_area %in% c("China", "United States of America"), year >= start_year, year<= current_year) |>
...
#Plot
ggplot(aes(x = infant_morality_rate_infant_deaths_per_1000_births, y = rate_of_natural_change_per_1000, color = region_subregion_country_area)) + 
  geom_point() +
...
estimates |>
  ...
  ggplot(aes(x = year, y = live_births_surviving_to_age_1_thousands, group = region_subregion_country_area, color = region_subregion_country_area)) +
  geom_line(size = 1.2) +
